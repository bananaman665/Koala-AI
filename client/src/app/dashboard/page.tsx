              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-5">
                {lectures.length > 0 ? (
                  ...
                  <div className="text-center py-4">
                    <div className="w-14 h-14 bg-blue-100 dark:bg-blue-500/15 rounded-xl flex items-center justify-center mx-auto mb-3">
                      <FiMic className="text-blue-600 dark:text-blue-400 text-2xl" />
                    </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-3 pt-4">
                <button
                  ...
                  disabled={isCreatingCourse}
                  className="flex-1 px-4 py-2 border border-red-300 dark:border-red-700 text-red-600 dark:text-red-400 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Cancel
                </button>
                <button
