          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {isLoadingCourses ? (
                ...
                <div className="col-span-2 text-center py-8 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-[#2C3E50]">
          ...
          <div key={course.id} className={isExitingCourse ? 'animate-zoom-out' : 'animate-zoom-in'}>
            ...
            <div className="mb-6">
              <button
                ...
                className="flex items-center space-x-2 px-4 py-2 bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-100 dark:hover:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg font-medium transition-colors mb-4"
              >
        ...
        {activeScreen === 'library' && selectedLecture && !isLearnModeActive && !isFlashcardModeActive && (
          <div className={`space-y-4 pb-20 ${isExitingLecture ? 'animate-zoom-out' : 'animate-zoom-in'}`}>
            ...
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-100 dark:hover:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg font-medium transition-colors"
            >
              <FiHome className="text-lg" />
              <span>Back to Home</span>
            </button>
