        ...
        <div className="px-4 sm:px-6 lg:px-4 pt-4 pb-8 lg:pb-4">
          ...
          {currentQuestion.keywords && currentQuestion.keywords.length > 0 && (
            <div className="mt-6 space-y-3">
              <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Key Terms</h3>
              <div className="space-y-2">
                {currentQuestion.keywords.map((keyword, idx) => (
                  <div
                    key={idx}
                    className="p-2.5 bg-purple-50 dark:bg-purple-500/10 border border-purple-200 dark:border-purple-500/30 rounded-lg"
                  >
