...
import { HelpCircle, Lock, Settings, ChevronLeft, Edit2, Clock, CheckCircle, Gift, FileText, BookOpen, Mic, Flame, Check, X, Loader2 } from 'lucide-react'
  ...
  if (authLoading || loading) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-[#0B1220] flex items-center justify-center">
        <Clock size={32} className="text-gray-600 dark:text-gray-400 animate-spin" />
      </div>
    )
  }
